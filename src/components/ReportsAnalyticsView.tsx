...
<body>
  ...
  <div class="metric-grid">
    <div class="card">
      ...
      <div class="card-value" style="color: #0f172a;">$${totalFleetCost.toLocaleString()}</div>
    </div>
    <div class="card">
      <div class="card-label">Cumulative Maintenance Spend</div>
      <div class="card-value" style="color: #d97706;">$${totalRepairCost.toLocaleString()}</div>
    </div>
    <div class="card">
      <div class="card-label">Annual Depreciation (15%)</div>
      <div class="card-value" style="color: #059669;">$${estimatedDepreciation.toLocaleString()}</div>
    </div>
  </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
        <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-xs space-y-1">
          ...
          <span className="text-2xl font-black font-mono text-slate-900 block">${totalFleetCost.toLocaleString()}</span>
        ...
        <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-xs space-y-1">
          ...
          <span className="text-2xl font-black font-mono text-amber-600 block">${totalRepairCost.toLocaleString()}</span>
        ...
        <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-xs space-y-1">
          ...
          <span className="text-2xl font-black font-mono text-emerald-600 block">${estimatedDepreciation.toLocaleString()}</span>
        ...
        <div className="bg-white border border-slate-200 p-4 rounded-xl shadow-xs space-y-1">
          ...
          <span className="text-2xl font-black font-mono text-blue-700 block">${totalTco.toLocaleString()}</span>
              ...
              <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm space-y-4">
                ...
                <div className="grid grid-cols-3 gap-3 text-center font-mono py-2">
                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    ...
                    <span className="text-lg font-bold text-slate-900">${totalFleetCost.toLocaleString()}</span>
                  </div>
                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <span className="text-[10px] text-slate-400 uppercase font-bold block">Maintenance</span>
                    <span className="text-lg font-bold text-amber-600">${totalRepairCost.toLocaleString()}</span>
                  </div>
                  <div className="p-3 bg-slate-50 rounded-lg border border-slate-200">
                    <span className="text-[10px] text-slate-400 uppercase font-bold block">Annual Depr.</span>
                    <span className="text-lg font-bold text-emerald-600">${estimatedDepreciation.toLocaleString()}</span>
                  </div>
                </div>
                    ...
                    <tbody className="divide-y divide-slate-100 font-mono text-[11px]">
                      {Object.entries(categoryStats).map(([cat, stat]) => (
                        <tr key={cat}>
                          ...
                          <td className="p-2 text-right">${stat.totalCost.toLocaleString()}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
